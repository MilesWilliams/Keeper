...
class Users(models.Model):
    ...
    groups = models.ManyToManyField(Groups, related_name="Group_Users")
    ...
    user_type = models.CharField("User Type", choices=user_type_choices, default=USER, max_length=10)
